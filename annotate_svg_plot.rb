...
###annotate structure models with high-confidence structure score data; called by refold_ratio.rb
...
if doAnnotation
	...
	def heat_scale(a, b, x, color_scheme, hmin, hmax)
		# x     R G B
		# 0     0 0 1
		# 0.25  0 1 1
		# 0.5   0 1 0
...
#			sx = Float(x/b)
	...
	0.upto(ratio.size-1) do |i|
		...
		if color_scheme == "discrete"
			...
			heatstr = heat_scale(ratio.min, ratio.max, c, color_scheme, hmin, hmax)
